...
function TopBar({ tab, setTab }) {
  ...
  return (
    <div className="topbar">
      ...
      <button className="iconbtn"><Icon name="bell" size={15} /><span className="dot"></span></button>
  ...
  return (
    <div>
      ...
      <div className="page">
        ...
        {/* Row 2: Lead sources (wide) + Funnel */}
        ...
        {/* Row 6: Best jobs + Reviews */}
        <div className="row split-3-2">
          <BestQualityJobs />
          <ReviewsCard />
        </div>

        {/* Row 7: Ops efficiency */}
        <OperationsMetrics />
